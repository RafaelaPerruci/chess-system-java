...
import br.com.rafaelaperruci.chess.pieces.Bishop;
import br.com.rafaelaperruci.chess.pieces.King;
import br.com.rafaelaperruci.chess.pieces.Pawn;
...
public class ChessMatch {
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        if (capturedPiece != null){
            board.placePiece(capturedPiece, target);      //desfazer lógica se expor meu Rei em chek
